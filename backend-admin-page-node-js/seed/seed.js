...
const products = [
    ...
    { image: 'https://dpi399zi9oi5i.cloudfront.net/wp-content/uploads/2021/06/15174742/WhatsApp-Image-2021-06-14-at-1.52.21-PM.jpeg', categories_id: 1, name: 'Mini kitchen', price: 100, discount_percentage: 20,description: 'Mini kitchen. There is a saucepan and a frying pan to prepare the tastiest imaginative menus. There is even a small sink, two spatulas and the essentials for any meal: salt and pepper shakers. This cute little kitchen is foldable for easy portability and to pack all accessories inside.'},
    ...
    { image: 'https://ae01.alicdn.com/kf/Hc5ba085f9e2542ac824cc1192f06e8d7h.jpg', categories_id: 2, name: 'Excavator', price: 30, discount_percentage: 25,description: 'Tonka Excavator is made of cold-rolled steel and features colorful and realistic detail.Features a movable arm with a heavy-duty metal bucket to dig and haul. Real working treads allow you to maneuver through any job site in style'},
    { image: 'https://m.media-amazon.com/images/I/71auvSc8ClL._AC_SL1500_.jpg', categories_id: 1, name: 'Mini kitchen', price: 100, discount_percentage: 70,description: 'Mini kitchen. There is a saucepan and a frying pan to prepare the tastiest imaginative menus. There is even a small sink, two spatulas and the essentials for any meal: salt and pepper shakers. This cute little kitchen is foldable for easy portability and to pack all accessories inside.'},
    ...
    { image: 'https://m.media-amazon.com/images/I/71YBUL+hxLL._AC_UF894,1000_QL80_.jpg', categories_id: 3, name: 'Wooden Log Cabin Set Building House Toy', price: 30, discount_percentage: 50,description: 'A timeless retro toy for kids and adults alike, these traditional building logs have just the right mix of modern durability and classic style. Childhood memories are waiting to be archived with these amazing wood logs'}
];
